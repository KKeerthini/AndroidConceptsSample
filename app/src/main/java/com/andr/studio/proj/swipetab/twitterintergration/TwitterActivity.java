...
import com.andr.studio.proj.swipetab.deletenundo.MainActivity;
...
public class TwitterActivity extends Activity implements View.OnClickListener {
    ...
    private static final String TWITTER_KEY = "JYzsuCfYMTkc7T91mE3gSqmu2";
    private static final String TWITTER_SECRET = "IsYZluYq8YRsJPMKUhpIEaVIXmEat7KWJu97vw6dzIPNB8ZE6N";
...
/**
                ...
                final Intent intent = new Intent(this, WebViewTwitterActivity.class);
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            try {
                ...
                InputStream is = getResources().openRawResource(R.drawable.ab_dropdown);
