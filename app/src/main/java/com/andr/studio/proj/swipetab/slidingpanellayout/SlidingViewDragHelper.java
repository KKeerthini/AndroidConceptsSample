 ...
 */
public class SlidingViewDragHelper {
     ...
     * @return a new ViewDragHelper instance
     */
    public static SlidingViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final SlidingViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private SlidingViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
