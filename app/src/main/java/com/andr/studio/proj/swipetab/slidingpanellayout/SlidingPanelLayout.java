...
public class SlidingPanelLayout extends ViewGroup {
    ...
    private final SlidingViewDragHelper mDragHelper;
    ...
    public SlidingPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragHelper = SlidingViewDragHelper.create(this, 0.5f, new DragHelperCallback());
    ...
    public boolean dispatchTouchEvent(@NonNull MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            mDragHelper.setDragState(SlidingViewDragHelper.STATE_IDLE);
        }
    ...
    private class DragHelperCallback extends SlidingViewDragHelper.Callback {
        ...
        public void onViewDragStateChanged(int state) {
            if (mDragHelper.getViewDragState() == SlidingViewDragHelper.STATE_IDLE) {
